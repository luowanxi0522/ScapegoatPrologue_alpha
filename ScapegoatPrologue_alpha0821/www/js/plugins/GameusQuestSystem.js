...
// Author gameus
// Version 1.01
// CHT version fixed by JEK and Encore.
//-----------------------------------------------------------------------------
// Intro:
...
/*:
 * @plugindesc v1.01 - gameus一個簡單的，具有許多可自行設定選項的任務系統。
 * @author gameus
 *
 * @param Auto Rewards
 ...
 * @desc 任務選單顯示文字 預設：已完成
 * @default 已完成
 *
 * @param Failed Word
 * @desc 任務選單顯示文字 預設：已失敗
 * @default 已失敗
 * 
 * @param In-Progress Word
 * @desc 任務選單顯示文字 預設：進行中
 * @default 進行中
 *
 * @param Steps Word
 * @desc 任務選單顯示文字 預設：階段
 ...
 * @desc 過濾視窗(預設顯示"全部")的位置。可以選擇上(Top)或下(Bottom)。預設為Top
 * @default Top
 * @type combo
 * @option Top
 * @option Bottom
 ...
 * @desc 是否顯示空類別。0：不顯示，1：灰階顯示，2：顯示，但在其下顯示"沒有任務"。預設為 0:不顯示
 * @default 0
 * @type combo
 * @option 0
 * @option 1
